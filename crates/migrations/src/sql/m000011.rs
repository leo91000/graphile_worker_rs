...
pub const M000011_MIGRATION: ArchimedesMigration = ArchimedesMigration {
    name: "m000011",
    is_breaking: true,
    stmts: &[
        indoc! {r#"
            lock table :ARCHIMEDES_SCHEMA.jobs;
        "#},
        indoc! {r#"
            lock table :ARCHIMEDES_SCHEMA.job_queues;
        "#},
        indoc! {r#"
        ...
        "#},
        indoc! {r#"
            alter table :ARCHIMEDES_SCHEMA.jobs
            alter column attempts type int2,
            alter column max_attempts type int2,
            alter column priority type int2;
        "#},
        indoc! {r#"
            drop function :ARCHIMEDES_SCHEMA.complete_job;
        "#},
        indoc! {r#"
            drop function :ARCHIMEDES_SCHEMA.fail_job;
        "#},
        indoc! {r#"
            drop function :ARCHIMEDES_SCHEMA.get_job;
        "#},
        indoc! {r#"
            drop trigger _900_notify_worker on :ARCHIMEDES_SCHEMA.jobs;
        "#},
        indoc! {r#"
        ...
        "#},
        indoc! {r#"
            drop function :ARCHIMEDES_SCHEMA.permanently_fail_jobs;
        "#},
        indoc! {r#"
        ...
        "#},
        indoc! {r#"
            drop function :ARCHIMEDES_SCHEMA.tg_jobs__notify_new_jobs;
        "#},
        indoc! {r#"
            alter table :ARCHIMEDES_SCHEMA.jobs rename to jobs_legacy;
        "#},
        indoc! {r#"
            alter table :ARCHIMEDES_SCHEMA.job_queues rename to job_queues_legacy;
        "#},
        indoc! {r#"
        ...
        "#},
        indoc! {r#"
            create table :ARCHIMEDES_SCHEMA.tasks (
                id int primary key generated always as identity,
                identifier text not null unique check (length(identifier) <= 128)
            );
        "#},
        indoc! {r#"
            alter table :ARCHIMEDES_SCHEMA.tasks enable row level security;
        "#},
        indoc! {r#"
        ...
        "#},
        indoc! {r#"
            create type :ARCHIMEDES_SCHEMA.job_spec as (
                identifier text,
                payload json,
                queue_name text,
                run_at timestamptz,
        ...
        "#},
        indoc! {r#"
            create function :ARCHIMEDES_SCHEMA.add_jobs(
        ...
        "#},
        indoc! {r#"
            create function :ARCHIMEDES_SCHEMA.complete_jobs(job_ids bigint[])
            returns setof :ARCHIMEDES_SCHEMA.jobs
            as $$
        ...
        "#},
        indoc! {r#"
            create function :ARCHIMEDES_SCHEMA.remove_job(job_key text)
        ...
        "#},
        indoc! {r#"
            create function :ARCHIMEDES_SCHEMA.tg_jobs__after_insert() returns trigger
            as $$
            begin
        ...
        indoc! {r#"
            ...
            after insert on :ARCHIMEDES_SCHEMA.jobs
            for each statement
            execute procedure :ARCHIMEDES_SCHEMA.tg_jobs__after_insert();
        "#},
        indoc! {r#"
        ...
        indoc! {r#"
            ...
            from :ARCHIMEDES_SCHEMA.jobs_legacy
        ...
        indoc! {r#"
            insert into :ARCHIMEDES_SCHEMA.jobs (
                ...
                select
                    ...
                    legacy.revision,
                    legacy.flags
                from :ARCHIMEDES_SCHEMA.jobs_legacy legacy
                inner join :ARCHIMEDES_SCHEMA.tasks
        ...
        "#},
        indoc! {r#"
            drop table :ARCHIMEDES_SCHEMA.jobs_legacy;
        "#},
        indoc! {r#"
            drop table :ARCHIMEDES_SCHEMA.job_queues_legacy;
        "#},
    ],
};

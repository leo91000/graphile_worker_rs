...
## [0.13.6](https://github.com/leo91000/graphile_worker_rs/compare/graphile_worker-v0.13.5...graphile_worker-v0.13.6) - 2026-09-26

### Fixed

- strengthen release validation and workflow isolation
- validate release APIs across supported feature sets
- yield during cron catch-up and backfill
- backport cron recovery and queue cleanup fixes

### Other

- *(deps)* update all non-major dependencies ([#527](https://github.com/leo91000/graphile_worker_rs/pull/527))
- refresh upstream ports with release validation repair
- *(deps)* update dependency @iconify-json/lucide to v1.2.134 ([#525](https://github.com/leo91000/graphile_worker_rs/pull/525))
- *(deps)* update rust crate syn to 3.0.6 ([#523](https://github.com/leo91000/graphile_worker_rs/pull/523))
- *(deps)* update dependency @iconify-json/lucide to v1.2.133 ([#522](https://github.com/leo91000/graphile_worker_rs/pull/522))
- *(deps)* update rust crate clap to 4.6.7 ([#521](https://github.com/leo91000/graphile_worker_rs/pull/521))
- *(deps)* lock file maintenance ([#520](https://github.com/leo91000/graphile_worker_rs/pull/520))
- *(deps)* update dependency @iconify-json/lucide to v1.2.132 ([#519](https://github.com/leo91000/graphile_worker_rs/pull/519))
- *(deps)* update dependency @iconify-json/lucide to v1.2.131 ([#518](https://github.com/leo91000/graphile_worker_rs/pull/518))
- *(deps)* update rust crate uuid to 1.26.1 ([#517](https://github.com/leo91000/graphile_worker_rs/pull/517))
- *(deps)* update dependency node to v24.21.0 ([#516](https://github.com/leo91000/graphile_worker_rs/pull/516))
- *(deps)* update dependency @iconify-json/lucide to v1.2.130 ([#515](https://github.com/leo91000/graphile_worker_rs/pull/515))
- express cron recovery completion invariants
- *(deps)* update all non-major dependencies ([#513](https://github.com/leo91000/graphile_worker_rs/pull/513))
- *(deps)* update rust to v1.98.1 ([#512](https://github.com/leo91000/graphile_worker_rs/pull/512))
- *(deps)* update dependency @iconify-json/lucide to v1.2.129 ([#511](https://github.com/leo91000/graphile_worker_rs/pull/511))
- *(deps)* update dependency @iconify-json/lucide to v1.2.128 ([#510](https://github.com/leo91000/graphile_worker_rs/pull/510))
- *(deps)* update dependency @iconify-json/lucide to v1.2.127 ([#509](https://github.com/leo91000/graphile_worker_rs/pull/509))
- *(deps)* update all non-major dependencies ([#508](https://github.com/leo91000/graphile_worker_rs/pull/508))
- *(deps)* update all non-major dependencies ([#507](https://github.com/leo91000/graphile_worker_rs/pull/507))
- *(deps)* update rust crate uuid to 1.25.0 ([#506](https://github.com/leo91000/graphile_worker_rs/pull/506))
- *(deps)* update dependency @iconify-json/lucide to v1.2.125 ([#505](https://github.com/leo91000/graphile_worker_rs/pull/505))
- *(deps)* update rust to v1.98.0 ([#504](https://github.com/leo91000/graphile_worker_rs/pull/504))
- *(deps)* update dependency @iconify-json/lucide to v1.2.124 ([#503](https://github.com/leo91000/graphile_worker_rs/pull/503))
- *(deps)* update rust crate uuid to 1.24.1 ([#502](https://github.com/leo91000/graphile_worker_rs/pull/502))
- *(deps)* update rust crate futures to 0.3.34 ([#501](https://github.com/leo91000/graphile_worker_rs/pull/501))
- *(deps)* update dependency @iconify-json/lucide to v1.2.123 ([#500](https://github.com/leo91000/graphile_worker_rs/pull/500))
...
- stabilize local queue init hook test
- support mutable tokio-postgres transactions
- accept transaction executors for add_job

### Other

- cover native executor argument queries
- remove driver-specific executor probing
- *(deps)* update dependency @iconify-json/lucide to v1.2.109 ([#421](https://github.com/leo91000/graphile_worker_rs/pull/421))
...
- refresh task identifiers for ctx cleanup

### Other

- stabilize local queue hook checks
- drop gc task identifiers repro example
- *(deps)* update rust crate uuid to 1.20.0 ([#370](https://github.com/leo91000/graphile_worker_rs/pull/370))
- *(deps)* update rust crate quote to 1.0.44 ([#369](https://github.com/leo91000/graphile_worker_rs/pull/369))
- *(deps)* update rust crate thiserror to 2.0.18 ([#368](https://github.com/leo91000/graphile_worker_rs/pull/368))
